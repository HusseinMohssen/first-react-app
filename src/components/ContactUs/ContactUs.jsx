    ...
    <>
      <div id='contactUS'>
        <div className='text-center'>
                <h2 style={{fontWeight: '700', fontSize: '40px',  paddingTop: '20px'}}>CONATCT SECTION</h2>
                <div>
                  <div className='d-flex justify-content-center align-items-center'>
                    <div style={{width: '90px', height:'4px', backgroundColor: '#2C3E50', marginRight: '1rem'}}></div>
                      <div><i className="fa-solid fa-star "></i></div>
                    <div style={{width: '90px', height:'4px', backgroundColor: '#2C3E50', marginLeft: '1rem'}}></div>
                  </div>
              </div>
            </div>
